...
{	// Texture 로딩하기
	...
	m_pTex = CResMgr::GetInstance()->LoadTexture(L"PlayerTex", L"texture\\link_0.bmp");
	CreateAnimator();
	GetAnimator()->CreateAnimation(m_pTex, Vec2(0.f, 260.f), Vec2(60.0f, 65.0f), Vec2(60.0f, 0.f) , 10);
}
